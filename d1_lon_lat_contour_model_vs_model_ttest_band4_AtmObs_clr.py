...
#---
varnmtoa="FSSD10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnmtoa_sub="FSSUCLR10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnmsfc="FSSDCLRS10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnmsfc_sub="FSSUCLRS10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
