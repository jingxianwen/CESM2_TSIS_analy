...
#---
varnm="FSSD08"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnm_sub="FSSU08"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
...
for i in range(0,1):
   #1. first plot
    ...
    # title
    ax.set_title("Diff in TOA Net Flux (TSIS - CESM2, Band 0.78-1.24)",loc="center",fontdict=plotSideTitle)
...
#    plt.show()
plt.savefig("./figures/diff_toa_band_0.78-1.24.eps")
plt.show()
plt.close()
