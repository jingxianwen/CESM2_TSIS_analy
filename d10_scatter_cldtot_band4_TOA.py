...
ctl_pref_fssd="solar_CTL_cesm211_ETEST-f19_g17-ens0_fssd"
exp_pref_fssd="solar_TSIS_cesm211_ETEST-f19_g17-ens0_fssd"

fpath_ctl="/raid00/xianwen/cesm211_solar/"+ctl_pref+"/climo/"
fpath_exp="/raid00/xianwen/cesm211_solar/"+exp_pref+"/climo/"
fpath_ctl_fssd="/raid00/xianwen/cesm211_solar/"+ctl_pref_fssd+"/climo/"
fpath_exp_fssd="/raid00/xianwen/cesm211_solar/"+exp_pref_fssd+"/climo/"
...
varnm_2=["FSSD10","FSSU10"]  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
...
for iy in range(0,years.size):
   ...
   fctl_fssd=fpath_ctl_fssd+ctl_pref_fssd+"_climo_ANN.nc"
   fexp_fssd=fpath_exp_fssd+exp_pref_fssd+"_climo_ANN.nc"
   ...
   means_yby_ctl_rad[iy,:,:]=file_ctl_fssd.variables[varnm_2[0]][0,:,:]-\
                             file_ctl.variables[varnm_2[1]][0,:,:]
   means_yby_exp_rad[iy,:,:]=file_exp_fssd.variables[varnm_2[0]][0,:,:]-\
...
fig.text(0.07,0.5,r"Diff in Net Flux (Wm$^-$$^2$)",fontsize=14,va='center',ha='center',rotation='vertical')
plt.savefig("./figures/scat_cldtot_band4_toa.eps")
plt.show()
