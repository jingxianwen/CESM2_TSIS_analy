...
varnmsfc="FSSD10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
...
means_ctl[:,:]=file_ctl.variables[varnmtoa][0,:,:]-file_ctl.variables[varnmsfc][0,:,:]
means_exp[:,:]=file_exp.variables[varnmtoa][0,:,:]-file_ctl.variables[varnmsfc][0,:,:]
