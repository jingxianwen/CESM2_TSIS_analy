...
#---
varnmtoa="FSSD08"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnmtoa_sub="FSSUCLR08"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnmsfc="FSSDCLRS08"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnmsfc_sub="FSSUCLRS08"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
...
for i in range(0,1):
   #1. first plot
    ...
    # title
    ax.set_title("Diff in Atm Abs CLR (TSIS - CESM2, Band 0.78-1.24)",loc="center",fontdict=plotSideTitle)
...
#    plt.show()
plt.savefig("./figures/diff_atm_abs_clr_band_0.78-1.24.eps")
plt.show()
plt.close()
