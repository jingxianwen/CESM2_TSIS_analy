...
#---
varnm="TGCLDLWP"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
...
for iy in range(0,years.size):
   ...
   means_yby_ctl[iy,:,:]=file_ctl.variables[varnm][0,:,:]*1000.
   means_yby_exp[iy,:,:]=file_exp.variables[varnm][0,:,:]*1000.
...
for i in range(0,1):
   #1. first plot
    ...
    # title
    ax.set_title("Diff in LWP (TSIS - CESM2)",loc="center",fontdict=plotSideTitle)
