...
varnm_2=["FSSDCLRS08","FSSUCLRS08"]  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
...
for ib in range(0,2):
  ...
  iy=0
#---box plot---
  dice_0=(diffs_cld[il_1[ib]:il_2[ib],:]>-.1)*(diffs_cld[il_1[ib]:il_2[ib],:]<.1) #*(means_exp_cld[il_1[ib]:il_2[ib],:] >10.)
...
plt.savefig("./figures/scat_icefrac_band6_sfc_clr.png",dpi=150)
plt.show()
