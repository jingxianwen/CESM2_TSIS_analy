...
means_ctl[:,:]=file_ctl.variables[varnmtoa][0,:,:]-file_ctl.variables[varnmtoa_sub][0,:,:]-\
                      (file_ctl.variables[varnmsfc][0,:,:]-file_ctl.variables[varnmsfc_sub][0,:,:])
means_exp[:,:]=file_exp.variables[varnmtoa][0,:,:]-file_exp.variables[varnmtoa_sub][0,:,:]-\
...
#    plt.show()
#plt.savefig("./figures/diff_atm_abs_band_0.44-0.63_5days.eps")
plt.show()
plt.close()
