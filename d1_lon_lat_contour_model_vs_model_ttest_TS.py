...
#---
varnm="TS"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="JJA"
...
diff_levs=np.linspace(-1.5,1.5,11) #[-50, -40, -30, -20, -10, -5, 5, 10, 20, 30, 40, 50]
colormap="PiYG_r"
colormap_diff="RdYlBu_r"
...
for i in range(0,1):
   #1. first plot
    ...
    # title
    ax.set_title("Diff in Surface Temperature (TSIS - CESM2, "+season+")",loc="center",fontdict=plotSideTitle)
...
#    plt.show()
plt.savefig("./figures/diff_ts_"+season+".eps")
plt.show()
plt.close()
