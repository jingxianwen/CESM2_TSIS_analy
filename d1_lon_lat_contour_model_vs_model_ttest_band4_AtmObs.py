...
varnmtoa_sub="FSSU10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnmsfc="FSSDS10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
varnmsfc_sub="FSSUS10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
...
for i in range(0,1):
   #1. first plot
    ...
    # title
    ax.set_title("Diff in Atm Abs (TSIS - CESM2, Band 0.44-0.63)",loc="center",fontdict=plotSideTitle)
...
#    plt.show()
plt.savefig("./figures/diff_atm_abs_band_0.44-0.63.eps")
plt.show()
plt.close()
