...
#---
varnm="FSSDCLRS10"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
...
for i in range(0,1):
   #1. first plot
    ...
    # title
    ax.set_title("Diff in SFC CLR Down Flux (TSIS - CESM2, Band 0.44-0.63)",loc="center",fontdict=plotSideTitle)
...
#    plt.show()
plt.savefig("./figures/diff_sfc_clr_down_band_0.44-0.63.eps")
plt.show()
plt.close()
