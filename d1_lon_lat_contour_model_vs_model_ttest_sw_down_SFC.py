...
diff_levs=np.linspace(-5.0,5.0,11) #[-50, -40, -30, -20, -10, -5, 5, 10, 20, 30, 40, 50]
colormap="PiYG_r"
colormap_diff="bwr"
...
for i in range(0,1):
   #1. first plot
    ...
    # title
    ax.set_title("Diff in SFC SW Down Flux (TSIS - CESM2)",loc="center",fontdict=plotSideTitle)
...
#    plt.show()
plt.savefig("./figures/diff_sfc_down_sw.eps")
plt.show()
plt.close()
