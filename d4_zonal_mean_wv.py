...
figure_name="zonal_tpw_cwp_shaded"
#units=r"Wm$^-$$^2$"
units=r"kg m$^-$$^2$"
units2=r"g m$^-$$^2$"

#varnms_vis_wv=np.array(["FSSDS13","FSSDS12","FSSDS11","FSSDS10","FSSDS09"])
#varnms_nir_wv=np.array(["FSSDS08","FSSDS07","FSSDS06","FSSDS05","FSSDS04",\
#                     "FSSDS03","FSSDS02","FSSDS01","FSSDS14"])
#
#varnms_vis_wv=np.array(["FSSUS13","FSSUS12","FSSUS11","FSSUS10","FSSUS09"])
#varnms_nir_wv=np.array(["FSSUS08","FSSUS07","FSSUS06","FSSUS05","FSSUS04",\
...
#ax1.plot(lat[:],means_exp_wv[:],color="g",lw=2,ls="-",label="NIR down")
...
#ax2.plot(lat[:],diffs_sig_wv[:],color="peachpuff",lw=6,alpha=0.9)
#ax2.plot(lat[:],diffs_sig_wv[0,:],color="yellowgreen",lw=6,alpha=0.9)
#ax2.plot(lat[:],diffs_sig_wv[1,:],color="plum",lw=6,alpha=0.9)
