...
var_group_todo=1
# variable group 1:
varnms=np.array(["OMEGAT"])
#varnms=np.array(["FSNTOA","FSNS","TS"])
var_long_name="Vertical heat flux"
figure_name="fig6aux_vertical_heat_flux_zonal_ANN"
units=r"K Pa s$^-$$^1$"
