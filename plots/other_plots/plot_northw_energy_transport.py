...
figure_name="Band_by_Band_TOA_Upward_SW_"+season
units=r"W/m$^2$"
nlat=96
...
# titles
ax1.set_title("Northward Heat Transport ("+season+")",fontsize=12,fontweight='bold')
ax2.set_title("Diff in Northward Heat Transport ("+season+")",fontsize=12,fontweight='bold')
...
plt.savefig("./figures/"+"NHT_"+season+".pdf")
plt.savefig("./figures/"+"NHT_"+season+".png",dpi=150)
plt.show()
plt.close()
