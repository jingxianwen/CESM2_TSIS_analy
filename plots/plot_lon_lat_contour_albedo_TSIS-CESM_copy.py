...
dtexp=file_exp.variables[varnm][:,:,:] / file_exp.variables[varnm2][:,:,:]
...
labels=["VIS_albedo (CESM2)","VIS_albedo (TSIS-1)","\u0394"+"VIS_albedo (TSIS-1 - CESM2)"] 
...
for i in range(0,3):
   ...
   #1. first plot
    ...
    if i != 2:
        ...
        cnlevels=np.arange(-0.1,0.12,0.02)
