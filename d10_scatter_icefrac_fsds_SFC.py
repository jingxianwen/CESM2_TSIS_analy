...
varnm_2="FSDS"  #np.array(["FLNS","SOLIN","LHFLX","SHFLX"])
season="ANN"
...
fig.text(0.5,0.05,r"Diff in SFC Net SW (Wm$^-$$^2$)",fontsize=14,va='center',ha='center')
fig.text(0.03,0.5,"Diff in FICE (%)",fontsize=14,va='center',ha='center',rotation='vertical')
plt.savefig("./figures/scat_icefrac_fsds_sfc.eps",dpi=150)
plt.show()
